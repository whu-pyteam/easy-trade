  ...
  <div class="app-container">
    <el-card style="width: 1400px">
      <el-form label-position="top">
        <el-form-item label="悬赏名称:" style="width: 500px;">
          <el-card
            shadow="never"
          >
            {{data.aad105}}
        ...
        <el-form-item label="上传日期:" style="width: 500px;">
          <el-card
            ...
            shadow="never"
          >
            {{data.aad107.replace('T', ' ').replace('.000+0000', '')}}
          </el-card>
        </el-form-item>
...
<script>
  import {getRewardDetail, updateReward} from "@/api/reward";

  export default {
    name: 'reward-update',
    data() {
      return {
        aad101: this.$route.params.id,
        data: {
          aad103: '',
          aad105: '',
          aad107: '',
    ...
    methods: {
      fetchRewardDetail() {
        getRewardDetail(this.aad101).then(res => {
          console.log(res.data)
          this.data.aad103 = res.data.aad103
          this.data.aad105 = res.data.aad105
